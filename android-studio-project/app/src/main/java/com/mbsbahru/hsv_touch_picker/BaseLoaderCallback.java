 ...
 */
public abstract class BaseLoaderCallback implements LoaderCallbackInterface, org.opencv.android.LoaderCallbackInterface {
    ...
    public void onManagerConnected(int status)
    {
        switch (status)
        {
            ...
            case com.mbsbahru.hsv_touch_picker.LoaderCallbackInterface.MARKET_ERROR:
            {
            ...
            case com.mbsbahru.hsv_touch_picker.LoaderCallbackInterface.INSTALL_CANCELED:
            {
    ...
    @Override
    public void onPackageInstall(int operation, org.opencv.android.InstallCallbackInterface callback) {

    }

    public void onPackageInstall(final int operation, final com.mbsbahru.hsv_touch_picker.InstallCallbackInterface callback)
    {
        switch (operation)
        {
            case com.mbsbahru.hsv_touch_picker.InstallCallbackInterface.NEW_INSTALLATION:
            {
    ...
    protected final static String TAG = "OCV/BaseLoaderCallback";
}
