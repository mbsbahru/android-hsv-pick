...
public void setWhite() {
    Camera.Parameters params = mCamera.getParameters();
    params.setWhiteBalance(SeekBarVal.valWB);
    mCamera.setParameters(params);
}
...
public void setExposure(int expVal) {
    Camera.Parameters params = mCamera.getParameters();
    params.setVideoStabilization(true);
    params.setExposureCompensation(expVal);
...
public void setExposureLock(boolean lockval) {
    Camera.Parameters params = mCamera.getParameters();
    params.setAutoExposureLock(lockval);
//    params.setAutoExposureLock(true);
//    counter++;
//    if(counter < 50){
//        params.setAutoExposureLock(false);
